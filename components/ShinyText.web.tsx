...
interface ShinyTextProps {
  ...
  delay?: number;
  style?: any; // Accepting React Native style props
}
...
export default function ShinyText({
  ...
  // Flatten standard React Native styles to map them cleanly to standard HTML style attributes
  ...
  const gradientStyle: React.CSSProperties = {
    ...
    fontFamily: flatStyle.fontFamily || "system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif",
