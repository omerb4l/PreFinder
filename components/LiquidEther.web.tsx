  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        ...
        this.listenerTarget!.addEventListener('touchstart', this._onTouchStart as any, { passive: true } as any);
        this.listenerTarget!.addEventListener('touchmove', this._onTouchMove as any, { passive: true } as any);
