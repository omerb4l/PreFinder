...
const styles = StyleSheet.create({
  ...
  avatarPicker: { width: 100, height: 100, borderRadius: 50, backgroundColor: Colors.background, borderWidth: 2, borderColor: Colors.primary, position: 'relative' },
  ...
  input: { backgroundColor: Colors.background, color: Colors.text, padding: 12, borderRadius: 8, fontSize: 14 },
  ...
  agentChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, backgroundColor: Colors.background, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  ...
  agentChipTextActive: { color: Colors.background },
