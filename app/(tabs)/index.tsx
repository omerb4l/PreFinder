...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, SafeAreaView, Platform, useWindowDimensions, ActivityIndicator, Modal, ScrollView, Alert } from 'react-native';
